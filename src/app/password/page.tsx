        ...
        <div className='flex justify-center'>
          <form onSubmit={handleSubmit} className=' flex flex-col items-center gap-4 justify-center'>
            {/* <div className='relative'>
              <input value={values.password} onChange={handleChange} type="password" placeholder='Password' className='px-3 h-12 w-80 border-b-2 border-gray-200 rounded-2xl outline-none' name="password" id="" />
              {
